...
from config.custom_components.climate import (
    STATE_AUTO, STATE_COOL, STATE_HEAT, STATE_IDLE, STATE_OFF, 
    ClimateDevice, PLATFORM_SCHEMA, ATTR_EFFICIENCY)
...
class RadioThermostat(ClimateDevice):
    ...
    def __init__(self, device, hold_temp, away_temps):
        ...
        self._min_cost = 0
        self._max_comfort = 10
        self._efficiency = 5
        _LOGGER.info("Custom radio thermostat loaded")
    ...
    @property
    def min_cost(self):
        """Return the minimum value for the cost vs. comfort range."""
        return self._min_cost

    @property
    def max_comfort(self):
        """Return the maximum value for the cost vs. comfort range."""
        return self._max_comfort

    @property
    def efficiency(self):
        """Return the current value for the cost vs. comfort range."""
    ...
    def set_efficiency(self, **kwargs):
        """Set new efficiency."""
        _LOGGER.info("Changing efficiency")
        efficiency = kwargs.get(ATTR_EFFICIENCY)
        if efficiency is None:
            return
        self._efficiency = efficiency
        _LOGGER.info("Efficiency changed")
